package com.example.daniel.emutest.bar;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                float dot = (-(fprogress - 50 )* 3.56f + 178) *2.528f;

                Log.i("VERT_SEEK_BAR", "LOC_BAR: " + dot + " LOC_TOUCH: " + event.getY());
                if(Math.abs(event.getY() - dot) < 3) {
